...
describe('UserController', () => {
  ...
  before('setupApplication', async () => {
    ...
    userRepository = new UserRepository( testdb, async () => transactionRepository);
  });
  ...
  describe('POST /transactions', () => {
    beforeEach('setUp', async () => {
      const baseUser = {name: 'user 1', cpf: '0', cellphone: '0', amount: 1000, limit: 500}
    ...
    it('invalid amount', async () => {
      const transactionData = new Transaction({from: '1', to: '2', amount: -200})
